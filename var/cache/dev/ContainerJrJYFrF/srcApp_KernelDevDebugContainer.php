...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getPageControllerService()
    {
        ...
        $this->services['App\\Controller\\PageController'] = $instance = new \App\Controller\PageController(($this->services['twig'] ?? $this->getTwigService()));
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\ArticlleRepository' => ['privates', 'App\\Repository\\ArticlleRepository', 'getArticlleRepositoryService', false],
            ...
            'App\\Repository\\ArticlleRepository' => '?',
    ...
    /**
     * Gets the private '.service_locator.fmcaXlf' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_FmcaXlfService()
    {
        return $this->privates['.service_locator.fmcaXlf'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    /**
     * Gets the private 'App\Repository\ArticlleRepository' shared autowired service.
     *
     * @return \App\Repository\ArticlleRepository
     */
    protected function getArticlleRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/ArticlleRepository.php';

        return $this->privates['App\\Repository\\ArticlleRepository'] = new \App\Repository\ArticlleRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
    ...
    protected function getDebug_ArgumentResolver_NotTaggedControllerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.fmcaXlf'] ?? $this->get_ServiceLocator_FmcaXlfService())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
