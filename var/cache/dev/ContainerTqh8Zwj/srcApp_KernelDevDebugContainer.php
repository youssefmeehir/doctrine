...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getOrderControllerService()
    {
        ...
        $this->services['App\\Controller\\OrderController'] = $instance = new \App\Controller\OrderController(($this->services['twig'] ?? $this->getTwigService()), ($this->services['session'] ?? $this->getSessionService()), ($this->services['router'] ?? $this->getRouterService()), ($this->privates['App\\Repository\\ProductRepository'] ?? $this->getProductRepositoryService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->privates['session.flash_bag'] ?? ($this->privates['session.flash_bag'] = new \Symfony\Component\HttpFoundation\Session\Flash\FlashBag())));
    ...
    protected function getPageControllerService()
    {
        ...
        return $this->services['App\\Controller\\PageController'] = new \App\Controller\PageController(($this->services['twig'] ?? $this->getTwigService()));
    }
    ...
    protected function getProductControllerService()
    {
        ...
        $this->services['App\\Controller\\ProductController'] = $instance = new \App\Controller\ProductController(($this->services['twig'] ?? $this->getTwigService()), ($this->services['router'] ?? $this->getRouterService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->privates['App\\Repository\\ProductRepository'] ?? $this->getProductRepositoryService()), ($this->services['session'] ?? $this->getSessionService()), ($this->privates['session.flash_bag'] ?? ($this->privates['session.flash_bag'] = new \Symfony\Component\HttpFoundation\Session\Flash\FlashBag())));
    ...
    protected function getCache_AppService()
    {
        ...
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('8Ig3e35kzD', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    protected function getCache_SystemService()
    {
        ...
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('n6POMRR3HX', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['url' => $this->getEnv('resolve:DATABASE_URL'), 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driver' => 'pdo_mysql', 'driverOptions' => [], 'serverVersion' => '8.0.19', 'defaultTableOptions' => []], $a, $c, []);
    }
    ...
    /**
     * Gets the private '.service_locator.0GjviT9' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_0GjviT9Service()
    {
        return $this->privates['.service_locator.0GjviT9'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    /**
     * Gets the private '.service_locator.NnLiwdY' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_NnLiwdYService()
    {
        return $this->privates['.service_locator.NnLiwdY'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Controller\\PageController::home' => ['privates', '.service_locator.0GjviT9', 'get_ServiceLocator_0GjviT9Service', false],
            'App\\Controller\\ProductController::save' => ['privates', '.service_locator.QP_ij.U', 'get_ServiceLocator_QPIj_UService', false],
            'App\\Controller\\ProductController::show' => ['privates', '.service_locator.q0ZxzhK', 'get_ServiceLocator_Q0ZxzhKService', false],
            'App\\Controller\\PageController:home' => ['privates', '.service_locator.0GjviT9', 'get_ServiceLocator_0GjviT9Service', false],
            'App\\Controller\\ProductController:save' => ['privates', '.service_locator.QP_ij.U', 'get_ServiceLocator_QPIj_UService', false],
            'App\\Controller\\ProductController:show' => ['privates', '.service_locator.q0ZxzhK', 'get_ServiceLocator_Q0ZxzhKService', false],
        ], [
    ...
    /**
     * Gets the private '.service_locator.QP_ij.U' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_QPIj_UService()
    {
        return $this->privates['.service_locator.QP_ij.U'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'formHandler' => ['privates', 'App\\Service\\ProductFormHandler', 'getProductFormHandlerService', false],
        ], [
            'formHandler' => 'App\\Service\\ProductFormHandler',
        ]);
    }

    /**
     * Gets the private '.service_locator.q0ZxzhK' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_Q0ZxzhKService()
    {
        return $this->privates['.service_locator.q0ZxzhK'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'orderDRepo' => ['privates', 'App\\Repository\\OrderDetailRepository', 'getOrderDetailRepositoryService', false],
        ], [
            'orderDRepo' => 'App\\Repository\\OrderDetailRepository',
        ]);
    }
    ...
    protected function getProductTypeService()
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Service/CalculPrixTTC.php';

        return $this->privates['App\\Form\\ProductType'] = new \App\Form\ProductType(new \App\Service\CalculPrixTTC('0.2'));
    }
    ...
    /**
     * Gets the private 'App\Service\ProductFormHandler' shared autowired service.
     *
     * @return \App\Service\ProductFormHandler
     */
    protected function getProductFormHandlerService()
    {
        include_once \dirname(__DIR__, 4).'/src/Service/ProductFormHandler.php';

        return $this->privates['App\\Service\\ProductFormHandler'] = new \App\Service\ProductFormHandler(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));
    }
    ...
    protected function getCache_AnnotationsService()
    {
        ...
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('iKNpsrUUSo', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getDebug_ArgumentResolver_NotTaggedControllerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.NnLiwdY'] ?? $this->get_ServiceLocator_NnLiwdYService())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
